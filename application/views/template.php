    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                <img src="<?= base_url('assets/images') ?>/logo.jpg" alt="Ophela Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">PT.<b>OPHELA</b></span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <?php 
                        if($this->fungsi->user_login()->sex == 1){?>
                            <img src="<?= base_url('assets/template/admin') ?>/dist/img/avatar5.png" class="img-circle elevation-2" alt="User Image">
                        <?php } 
                        else{?>
                            <img src="<?= base_url('assets/template/admin') ?>/dist/img/avatar3.png" class="img-circle elevation-2" alt="User Image">
                        <?php } ?>
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item has-treeview <?= $this->uri->segment(1) == 'delivery_order' || $this->uri->segment(1) == 'sales' || $this->uri->segment(1) == 'received' || $this->uri->segment(1) == 'quotation' || $this->uri->segment(2) == 'in' || $this->uri->segment(2) == 'out' ? 'menu-open' : '' ?>">
                        <a href="#" class="nav-link <?= $this->uri->segment(1) == 'delivery_order' || $this->uri->segment(1) == 'sales' || $this->uri->segment(1) == 'received' || $this->uri->segment(1) == 'quotation' ||$this->uri->segment(2) == 'in' || $this->uri->segment(2) == 'out' ? 'active' : '' ?>">
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="<?= site_url('delivery_order') ?>" class="nav-link  <?= $this->uri->segment(1) == 'delivery_order' ? 'active' : '' ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Delivery Order</p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="<?= site_url('received') ?>" class="nav-link  <?= $this->uri->segment(1) == 'received' ? 'active' : '' ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Received</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview <?= $this->uri->segment(2) == 'sale_report' || $this->uri->segment(2) == 'stock_report' || $this->uri->segment(2) == 'report_sale' ? 'menu-open' : '' ?>">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?= site_url('reports/report_rekap') ?>" class="nav-link <?= $this->uri->segment(2) == 'report_rekap' ? 'active' : '' ?>">
                                    <i class="far fa-circle nav-icon"></i>
