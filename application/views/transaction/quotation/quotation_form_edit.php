                    ...
                    <div class="col-md-4 offset-md-4">
                        ...
                        <input type="hidden" name="id" id="id"  value="<?= $quotation_m[0]->id ?>" readonly class="form-control" aria-describedby="basic" autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="date" class="form-control" value="<?= $quotation_m[0]->date ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="expired_date" class="form-control" value="<?= $quotation_m[0]->expired_date ?>">
                            </div>
