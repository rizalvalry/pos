            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 offset-md-4">
                        <form id="formD" name="formD" action="<?= site_url('quotation/save_add_detail'); ?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id_quotation" id_quotation="id"  value="<?= $quotation_m[0]->id ?>" readonly class="form-control" aria-describedby="basic" autofocus>
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" name="price" id="price" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" class="form-control" autofocus>
                            </div>   
                        <div class="form-group">
                                <label for="qty" class="col-form-label">Qty <font color="#f00">*</font></label>
                                <input type="text" name="qty" id="qty" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" class="form-control" autofocus>
                            </div>    
                        <div class="form-group">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" name="amount" id="amount" value="" readonly="readonly" class="form-control" autofocus>
                            </div>   
                        <div class="form-group">
                                <label for="note" class="col-form-label">Note/ Deskripsi <font color="#f00">*</font></label>
                                <textarea name="note" id="note" rows="4" class="form-control" autofocus></textarea>
                            </div> 
