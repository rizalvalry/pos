                ...
                <div class="row">
                    <div class="col-md-4 offset-md-4">
                        <form action="<?= site_url('stock/process'); ?>" method="post">
                            ...
                            <div class="form-group">
                                <label for="detail" class="col-form-label">Info <font color="#f00">*</font></label>
                            ...
                            <div class="form-group">
                                <button class="btn btn-success btn-flat" type="submit" name="out_add"><i class="fa fa-paper-plane"></i> Save</button>
