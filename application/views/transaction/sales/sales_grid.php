                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        foreach ($sale as $s) { ?>
                            <tr>
                                <td><?= $no++; ?></td>
                                <td id="delivery_no"><?= $s->delivery_no; ?></td>
                                <td id="invoice_no"><?= $s->invoice_no; ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="<?= site_url('delivery_order/detail/' . $s->sale_id); ?>" title="Detail" class="btn btn-default btn-sm"><i class="fa fa-eye"></i></a>
                                    ...
                                    <a href="<?= site_url('delivery_order/edit/' . $s->sale_id); ?>" title="Update" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                    <a href="<?= site_url('sales/cetak/' . $s->sale_id); ?>" target="_blank" title="Print Delivery Order" class="btn btn-danger btn-sm"><i class="fas fa-shipping-fast"></i></a>
                                    <a href="<?= site_url('sales/invoice/' . $s->sale_id); ?>" target="_blank" title="Print Invoice Order" class="btn btn-danger btn-sm"><i class="fas fa-file-invoice-dollar"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
