        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Laporan Rekap Penjualan</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="card">
          <div class="card-header">
            <div class="d-flex justify-content-between">
              <h3 class="card-title">Laporan Rekap Penjualan</h3>
            </div>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
...
function simpanData(){
    if($.trim($("#tgl_start").val()) == ""){
        ...
        var s=$('#tgl_start').val();
        var e=$('#tgl_end').val();
        window.open('<?= site_url();?>reports/print_laporan_rekap?ts='+s+'&te='+e,'_blank');
    };
};
</script>