                            ...
                            <div class="modal-body">
                                <form method="post" target="_self" name="formku" id="formku" class="eventInsForm" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-8 col-xs-8">
                                            <input type="text" name="description" id="description" class="form-control" style="margin-bottom: 5px;" maxlength="100" autofocus>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 col-xs-4">
                                            <label for="purchase_price" class="col-form-label">Purchase Price <font color="#f00">*</font></label>
                                        </div>
                                        <div class="col-md-8 col-xs-8">
                                            <input type="number" name="purchase_price" id="purchase_price" class="form-control" style="margin-bottom: 5px;" maxlength="100" autofocus>
                                            <div class="invalid-feedback inv-purchase_price">
                                                &nbsp;
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <tbody>
                                ...
                                foreach ($item as $i) { ?>
                                    <tr>
                                        ...
                                        <td><?= $i->name_unit; ?></td>
                                        <td><?= indo_currency($i->purchase_price); ?></td>
...
<script>
    ...
    function simpandata() {
        if ($.trim($("#barcode").val()) == "") {
            ...
            $(".inv-purchase_price").html("Purchase Price tidak boleh kosong!");
