                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" target="_self" name="formku" id="formku" class="eventInsForm">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 col-xs-4">
                                            <label for="level" class="col-form-label">Sex <font color="#f00">*</font></label>
                                        </div>
                                    <div class="col-md-8 col-xs-8">
                                            <select id="sex" name="sex" class="form-control" style="margin-bottom: 5px;">
                                                <option disabled selected value="">--Pilih--</option>
...
<script>
    ...
    function simpandata() {
        if ($.trim($("#username").val()) == "") {
            ...
            $(".inv-sex").html("Sex tidak boleh kosong!");
